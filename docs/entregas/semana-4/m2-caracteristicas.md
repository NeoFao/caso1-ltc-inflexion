...
**Tabla 1.** Las 63 columnas, por familia.
...
**Tabla 2.** Las cinco columnas de mayor caída (F1 macro base: 0,390498).
...
**Tabla 4.** Efecto de quitar las 17 que no superan el piso.
