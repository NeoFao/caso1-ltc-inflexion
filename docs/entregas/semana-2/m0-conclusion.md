...
Lo que no se sostiene es el supuesto multivariante. La diferencia entre emplear los seis criptoactivos y emplear únicamente Litecoin es de **0,0090**, con un intervalo de **[−0,0229 , 0,0417]** que incluye el cero, por debajo del umbral, y con dos de cinco semillas arrojando diferencia negativa. **No puede afirmarse que las cinco series de apoyo aporten información sobre los puntos de inflexión de Litecoin.**

Un control posterior permite decirlo de forma más concreta. Al calibrar el banco de pruebas de representaciones se añadieron al modelo ocho columnas que reemiten información ya presente bajo otro nombre y que, por construcción, no aportan nada: su efecto medido es de **0,00071** de media, con el signo cambiando entre semillas. El aporte de los cinco activos de apoyo es de **0,00078**, con la misma inestabilidad. **La distancia que separa a ambos efectos es menor que la trescientava parte del umbral de decisión** que el equipo fijó de antemano. Lo que se mide al incorporar los cinco criptoactivos es, por tanto, del mismo tamaño que lo que se mide al no incorporar nada. El planteamiento multivariante era razonable a la vista de las correlaciones medidas en la Semana 1, y esa justificación de diseño se mantiene; lo que la medición añade es que dicha estructura no se traduce, con este modelo y a esta resolución, en poder predictivo distinguible del ruido.
