...
**Tabla 1.** Las cuatro pruebas, qué aísla cada una y qué pasó.
...
**Tabla 2.** Prueba 2, sobre serie sintética.
...
**Tabla 3.** Prueba 3, sobre entrenamiento (9 165 velas etiquetadas).
