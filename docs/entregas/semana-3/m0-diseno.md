...
**Tabla 1.** Distribución de clases en el bloque de entrenamiento.
...
**Tabla 2.** Los tres parámetros y la medición que los fijó.
...
La **Figura 1** muestra la partición completa. El embargo no se ve, y **que no se vea es el
