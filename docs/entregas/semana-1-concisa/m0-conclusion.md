...
**Primera. La transformación a retornos no es una convención, sino una consecuencia medida.** Ninguna de las seis series rechaza la hipótesis de raíz unitaria sobre precios en nivel, mientras que las seis la rechazan sobre retornos, y la autocorrelación en el primer rezago confirma el mismo hecho desde un ángulo distinto. En consecuencia, las características del modelo se construyen sobre retornos y sobre estadísticos normalizados por ventana, y no sobre magnitudes absolutas de precio.
