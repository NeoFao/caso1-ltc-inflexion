...
**Y es indistinguible de un control que no informa nada.** El arnés de representaciones se calibró añadiendo ocho columnas que reemiten información ya presente, con otro nombre: por construcción no aportan. Su efecto medido es de **+0,00071** de media, con el signo cambiando entre semillas. El aporte de los cinco activos de apoyo da **+0,00078**, con la misma inestabilidad. **La distancia entre los dos es menor que la trescientava parte del umbral de decisión** ([D16](docs/DECISIONES.md)).
