...
def rezagos(
    ...
    El cambio se discutio y acordo en el PR que lo introduce; ahi esta el hilo con
    los tres argumentos y las cifras. Evidencia: docs/evidencias/m2-escalado.json y
    m2-ablacion.json, regenerables con
