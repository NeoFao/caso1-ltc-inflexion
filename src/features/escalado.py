...
def generar_evidencia(directorio=None, w: int | None = None, h: int | None = None) -> dict:
    ...
    La granularidad, w y h se leen de `contracts/config.py`, que desde que el equipo
    los congelo dice 4h, w = 7 y h = 1. No se repiten aqui como valores por defecto
    propios: serian una segunda fuente de verdad, y la primera vez que el contrato
    ...
    evidencia = {
        "parametros": {"panel": GRANULARIDAD, "w": w, "h": h, "umbral_fuera_de_rango": 5.0},
