...
def test_comparar_sondas_exige_la_representacion():
    """No puede heredar el default de construir(): asi fue como se desincronizo.

    Antes del arreglo, `comparar_sondas` tomaba la representacion del
    ...
    from src.features.ablacion import comparar_sondas

    parametro = inspect.signature(comparar_sondas).parameters[
        "rezagos_relativos"
    ]
